      ...
      <div className="container flex md:gap-[150px] gap-2 flex-col md:flex-row items-center md:mx-0">
        <div className="left">
          <div className="flex flex-col justify-center items-start md:p-10 p-3 max-w-xl mx-auto">
            <p className="text-lg font-bold text-gray-700">Hi I am</p>
            <h1 className="text-3xl font-bold text-orange-500">
              Muhammad Umair
            </h1>
            <div className="md:text-[80px] text-[60px] md:my-[-15px] font-extrabold text-black" data-aos="fade-right">
              UI & UX <h2 className="md:ml-[130px] md:-mt-10 -mt-5" data-aos="fade-left">Designer</h2>
            </div>
